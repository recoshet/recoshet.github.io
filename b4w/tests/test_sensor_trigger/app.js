...
function load_cb(data_id) {
    ...
    //Ловим столкновения игрока, выводим в консоль
    var obj = m_scs.get_object_by_name('igrok');
    var sensor_collision = m_ctl.create_collision_sensor(obj, null, true);

    m_ctl.create_sensor_manifold(null, "COL", m_ctl.CT_TRIGGER, [sensor_collision], function(s){return s[0]},
        function(obj, id, pulse, param){
            ...
            console.log(collision_pt.coll_obj);
